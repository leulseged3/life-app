@push('additional-js')
  <script>
    $('#mhp-edit-modal').on('show.bs.modal', function(e) {
      var user = $(e.relatedTarget).data('mhp');
      $('#mhp_user_title').text("Edit " + user.first_name + " " + user.last_name + "'s Profile");
...
@endpush
<div class="modal fade" id="mhp-edit-modal" tabindex="-1" role="dialog" aria-labelledby="userEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" ><b id="mhp_user_title">Edit User</b></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
          </button>
      </div>
      <form method="POST" action="/mhps/edit">
        @csrf
